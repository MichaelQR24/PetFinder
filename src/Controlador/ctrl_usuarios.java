...
public class ctrl_usuarios {
    Usuario usuarios;
    Consulta_Usuario consulta_Usuarios;
    ...
    public ctrl_usuarios(Usuario usuarios, Consulta_Usuario consulta_Usuarios ) {
    ...
    public boolean Guardar(String user, String apellido, String dni,String correo, String pwd) {
